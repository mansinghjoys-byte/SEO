...
### Frontend (.env)
```bash
REACT_APP_BACKEND_URL=https://seo-rival-scan.preview.emergentagent.com
```
...
```bash
curl -X POST https://seo-rival-scan.preview.emergentagent.com/api/auth/register \
...
### Test Login
```bash
curl -X POST https://seo-rival-scan.preview.emergentagent.com/api/auth/login \
  -H "Content-Type: application/json" \
...
- API docs: `https://seo-rival-scan.preview.emergentagent.com/api/docs`
